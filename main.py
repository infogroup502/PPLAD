...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_size', type=list_type, default=[3])
    parser.add_argument('--global_size', type=list_type, default=[20])
    parser.add_argument('--lr', type=float, default=1e-4)
    parser.add_argument('--d_model', type=int, default=128)  ########
    parser.add_argument('--rec_timeseries', action='store_true', default=True)
    parser.add_argument('--similar', type=str, default='MSE')  # MSE cos kl
